...
我目前就讀於**東吳大學資料科學系**三年級。在實驗室研究與課程學習過程中，我觀察到傳統 IoT 教學缺乏互動性與即時回饋，因此投入研究如何結合**生成式 AI** 與 **AR 智慧眼鏡**，設計**多模態互動學習系統**，探索具備情境感知能力的智慧介面如何從根本改變人類的學習方式與互動體驗。
...
**Multimodal Human-Computer Interaction — 多模態人機互動**

結合視覺、語言與空間情境，設計具備情境感知能力的互動系統。

**Generative AI Applications — 生成式 AI 應用**

大型語言模型（LLM）、擴散模型與提示工程之研究與應用。

**Augmented Reality Systems — 擴增實境系統**
...
「聲動福華」專案：以 Podcast 銀齡共創課程促進社區跨世代交流，提升社會參與度。
